...
function showList(idx){
	...
	for(index = indexLength-1 ; index >= 0; index--) {
	    ...
	    var simg  = imgpath+"150x110/r/retsimages/"+list[index].ipath+"/image_"+list[index].ml_num+"_1.jpg";
            var price=list[index].asking;

	    var img  = imgpath+"600x400/r/retsimages/"+list[index].ipath+"/image_"+list[index].ml_num+"_1.jpg";
         ...
         success : function(data) {
		      ...
		      for (var i = 0; i < markers.length; i++) {
		        ...
		        var html ="";
                        ...
                        var aList = {ml_num:ml_num,ipath:ipath,asking:asking,addr:addr,bed:bed,bath:bath,lat:xlat,lon:xlon,min:min,max:max,rltr:rltr,count:count,dom:dom,community:community,municipality:municipality, page_url:page_url,type_own1_out:type_own1_out,index:i,building:building,multiple:multiple,lp_dol:lp_dol};
                        list.push(aList);
